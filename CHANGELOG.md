...
- **README**: Added a tip in the Requirements section suggesting the use of
  [Advanced Downloader](https://github.com/Geek-MD/Advanced_Downloader) for a more
  complete media file management experience.

### Added

- **HA notification**: A persistent notification is now shown in Home Assistant after
  the integration loads, suggesting the use of Advanced Downloader.
